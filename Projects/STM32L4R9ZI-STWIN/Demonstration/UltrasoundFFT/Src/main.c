...
int main(void)
{
  ...
  */
  ...
  /* Initialize MP23ABS1 peripherals and threads */
  MP23ABS1_Peripheral_Init(AUDIO_IN_SAMPLING_FREQUENCY, ACTIVE_MICROPHONES_MASK, AUDIO_IN_CHANNELS);
  MP23ABS1_OS_Init();
